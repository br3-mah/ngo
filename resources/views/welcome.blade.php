...
<!--         <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.4/css/fontawesome.min.css" integrity="sha384-jLKHWM3JRmfMU0A5x5AkjWkw/EYfGUAGagvnfryNV3F9VqM98XiIH7VBGVoxVSc7" crossorigin="anonymous"> -->
    ...
    <body class="has-background-black has-navbar-fixed-top">  
        <div class="">
            @if (Route::has('login'))
            ...
            <div class="hero-body">
                <div class="container has-text-centered">
                    <div class="column is-6 is-offset-3">
                        ...
                        <h2 class="subtitle">
                            We are here to build the capacity of CSOs based on their needs and coordinate CSOs including key population and vulnerable groups, so as to strengthen their participation in the multi sectoral national response to HIV, TB and Malaria and other disease epidemics.
                        </h2>
<!--                         <div class="box">
                            <div class="field is-grouped">
 ...
 CSSCM</strong><br/>
 Powered by <a href="https://datasync.co.zm">Datasync</a>
        </div>
    </footer>
</html>
